...
class GUI_Beginners:
    def __init__(self, root):
        ...
        self.btnTotal = Button(frame3, text="Total", font=('arial', 14, 'bold'), bd=12, pady=14, padx=12, width=7,
                               command=add).grid(row=0, column=0)
        self.btnReset = Button(frame3, text="Reset", font=('arial', 14, 'bold'), bd=12, pady=14, padx=12, width=7,
                               command=Reset).grid(row=0, column=1)
        self.btnExit = Button(frame3, text="Exit", font=('arial', 14, 'bold'), bd=12, pady=14, padx=12, width=7,
